<template>
    ...
    <Head title="Sale Return Invoices" />
        ...
        <div class="p-4 bg-white rounded-lg shadow-xs mt-6 space-y-6">
            <!-- <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
                ...
                <div class="px-4 py-2-mx-3 ">
                    <div class="mx-3">
                        <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('salereturninvoices.create')">
            ...
            <div class="overflow-hidden mb-8 w-full rounded-lg border shadow-xs">
                <div class="overflow-x-auto w-full">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(salereturninvoice, index) in salereturninvoices.data" :key="salereturninvoice.id"
                                class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ salereturninvoice.total_discount }}
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ salereturninvoice.service_charges }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ salereturninvoice.received_amount }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ salereturninvoice.remaining_balance }}
                                </td>
                              
                                <td class="px-4 py-3 text-sm">
                                    <button type="button" @click="generatePDF(salereturninvoice.id)"><svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
                ...
                <div
                    ...
                    <pagination :links="salereturninvoices.links" />
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
