        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y"  >
                <tr v-for="(balance, index) in balances" :key="index">
                    ...
                    <td class="px-1 py-2 text-sm">{{ index }}</td>
                    <td class="px-4 py-2 text-sm">{{ balance.name }}</td>
                    <td class="px-1 py-2 text-sm">{{ balance.latestVoucherAmount }}</td>
                    <td class="px-1 py-2 text-sm">{{ balance.formattedBalance }}  </td>
...
<script>
    ...
    export default {
        ...
        props:{
            start_date: Date, end_date: Date, balances: Array
        },
        ...
        methods: {
            ...
            downloadPDF() {
                ...
                try {
                    ...
                    const pdfOptions = {
                    margin: 5,
                    filename: 'account-receiveable.pdf',
