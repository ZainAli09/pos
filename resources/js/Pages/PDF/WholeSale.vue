        ...
        <table class="w-full whitespace-no-wrap">
            <thead>
                <tr
                    ...
                    <th class="px-1 py-3">Whole Sale Price</th>
            ...
            <tbody class="bg-white divide-y"  >
                <template v-for="sale in sales" :key="index">
                    ...
                    <template v-for="detail in sale.w_sale_invoice_detail">
                        <tr>
                            ...
                            <td class="px-1 py-2 text-sm">{{ detail.product.whole_sale_rate }}</td>
                            <td class="px-1 py-2 text-sm">{{ detail.quantity * detail.product.whole_sale_rate }}</td>
                        </tr>
                    </template>
