<template>
    ...
    <Head title="Whole Sale Invoices" />
        ...
        <div class="p-4 bg-white rounded-lg shadow-xs mt-6 space-y-6">
            <!-- <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
                ...
                <div class="px-4 py-2-mx-3 ">
                    <div class="mx-3">
                        <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('wsinvoices.create')">
                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(wsinvoice, index) in wsinvoices.data" :key="wsinvoice.id"
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button type="button" @click="generatePDF(wsinvoice.id)"><svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
...
<script>
    ...
    export default {
        ...
        methods:{
            generatePDF(id){
                this.$inertia.post('/generate-pdf/ws', {invoiceid: id});
            },
        },
    }
