                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(saleinvoice, index) in saleinvoices.data" :key="saleinvoice.id"
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button type="button" @click="generatePDF(saleinvoice.id)"><svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
