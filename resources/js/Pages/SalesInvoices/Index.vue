                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(saleinvoice, index) in filteredSaleInvoices" :key="saleinvoice.id"
                                ...
                                <td  class="px-4 py-3 text-sm">
                                    <a :href="route('editSaleInvoice', saleinvoice.id)"> <svg class="w-[21px] h-[21px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
