    ...
    <AuthenticatedLayout>
        ...
        <div>
            <form @submit.prevent="submitForm" class="mt-2 space-y-2">
                ...
                <div class="flex space-x-4" v-for="details in saleInvoice.sale_invoice_detail">
                    <div class="w-1/6">
  ...
  methods: {
    ...
    submitForm() {
        if(this.formData.received_amount >= this.formData.total){
            ...
            this.$inertia.put(route('saleinvoices.update', { id: this.saleInvoice.id }), this.formData, {
                onSuccess: () => {
