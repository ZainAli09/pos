        ...
        <div class="p-4 bg-white rounded-lg shadow-xs mt-6 space-y-6">
            <!-- <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
                ...
                <div class="px-4 py-2-mx-3 ">
                    <div class="mx-3">
                        <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('purchasereturninvoices.create')">
            ...
            <div class="overflow-hidden mb-8 w-full rounded-lg border shadow-xs">
                <div class="overflow-x-auto w-full">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(purchasereturninvoice, index) in purchasereturninvoices.data" :key="purchasereturninvoice.id"
                                class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ purchasereturninvoice.total_quantity }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ purchasereturninvoice.gross_amount }}
                                </td>
                                
                                <td class="px-4 py-3 text-sm">
                                    {{ purchasereturninvoice.total_discount }}
                                </td>

                                <td class="px-4 py-3 text-sm">
                                    {{ purchasereturninvoice.net_amount }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ purchasereturninvoice.service_charges }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <button type="button" @click="generatePDF(purchasereturninvoice.id)"><svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
                ...
                <div
                    ...
                    <pagination :links="purchasereturninvoices.links" />
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
