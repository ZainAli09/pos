        ...
        <div class="p-4 bg-white rounded-lg shadow-xs mt-6 space-y-6">
            <!-- <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
                ...
                <div class="px-4 py-2 -mx-3 ">
                    <div class="mx-3">
                        <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('categories.create')">
                ...
                <div class="overflow-x-auto w-full">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y">
                            <tr v-for="(category, index) in categories.data" :key="category.id" class="text-gray-700">
